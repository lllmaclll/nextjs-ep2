...
function Header() {
    ...
    const handleForm = (e) => {
        ...
        console.log("search string pokeName: ", pokeName)
        router.push(`/pokesearch/${pokeName}`) // router ส่งค่าไปหน้า /pokesearch/${pokeName}
    }
    ...
    <header className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-[300px] flex justify-center items-center'>
        <div className='text-center'>
            ...
            <form onSubmit={handleForm} className='flex mt-2'>
                <input 
                    type="text" 
                    className='w-full rounded-md border-gray-300 px-3 py-2 text-gray-700 shadow-md outline-none' 
